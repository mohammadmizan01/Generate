...
const steps = [
    ...
    {icon: TriangleIcon, label: "Generating layout Assembling UI Components ..."},
...
const LoaderSteps = () => {
    ...
    return(
        ...
        bg-gray-950 relaive overflow-hidden text-white">
            <div className="absolute inset-0 bg-linear-to0br from-blue-500/10
            via-purple-500/10 to-fuchsia-500/10 blur-3xl animate-pulse"></div>

            <div className="relative z-10 w-32 h-32 flex items-center justify-center">
                <div className="absolute inset-0 rounded-full border border-indigo0400
